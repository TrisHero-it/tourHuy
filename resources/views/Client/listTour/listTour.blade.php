                                ...
                                <div class="product-small box">
                                    <div class="box-image">
                                        <div class="image-none">
                                            <a href="{{ route('tour.detail', [$category->slug, $tour->slug]) }}" aria-label="{{ $tour->name }}">
                                                @if($tour->image)
                                    ...
                                    <div class="box-text box-text-products">
                                        <div class="title-wrapper">
                                            <p class="name product-title woocommerce-loop-product__title">
                                                <a href="{{ route('tour.detail', [$category->slug, $tour->slug]) }}" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">{{ $tour->name }}</a>
                                            </p>
                                        </div>
