...
Route::get('/', [HomeController::class, 'login'])->name('admin.login');
Route::post('/login', [HomeController::class, 'store'])->name('admin.login.store');
...
Route::middleware('check.login.admin')->group(function () {
    ...
    Route::get('/google-maps', [GoogleMapController::class, 'index'])->name('admin.google-maps.index');
    Route::get('/google-maps/create', [GoogleMapController::class, 'create'])->name('admin.google-maps.create');
    Route::post('/google-maps', [GoogleMapController::class, 'store'])->name('admin.google-maps.store');
    Route::get('/google-maps/{id}/edit', [GoogleMapController::class, 'edit'])->name('admin.google-maps.edit');
    Route::put('/google-maps/{id}', [GoogleMapController::class, 'update'])->name('admin.google-maps.update');
    Route::delete('/google-maps/{id}', [GoogleMapController::class, 'destroy'])->name('admin.google-maps.destroy');
    Route::put('/google-maps/{id}/status', [GoogleMapController::class, 'changeStatus'])->name('admin.google-maps.change-status');
